  ...
  <footer className="footer">
    <ul className="footer__list container">
      <li className="footer__item">
        <a href="https://github.com/Alesia-V175" target="_blank" className="footer__link" rel="noreferrer">
          <img src='../../src/assets/icons/github.svg'
               alt="Github" title="Alesia's Github"
               className="footer__logo_github" />
        </a>
      </li>
      <li className="footer__item">© by Alesia Sokolovskaya 2023</li>
      <li className="footer__item">
        <a href="https://rs.school/js/" target="_blank" className="footer__link" rel="noreferrer">
          <img src="../../src/assets/icons/rs-school.svg"
               alt="RS School" title="RS School"
               className="footer__logo_rs " />
        </a>
      </li>
    </ul>
  </footer>
